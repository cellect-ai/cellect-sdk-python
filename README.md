...
pip install git+ssh://git@github.com/cellect-ai/cellect-sdk-python.git
```
...
```sh
# install from the production repo
pip install 'cellect[aiohttp] @ git+ssh://git@github.com/cellect-ai/cellect-sdk-python.git'
```
...
These methods return an [`APIResponse`](https://github.com/cellect-ai/cellect-sdk-python/tree/main/src/cellect/_response.py) object.

The async client returns an [`AsyncAPIResponse`](https://github.com/cellect-ai/cellect-sdk-python/tree/main/src/cellect/_response.py) with the same structure, the only difference being `await`able methods for reading the response content.
...
We are keen for your feedback; please open an [issue](https://www.github.com/cellect-ai/cellect-sdk-python/issues) with questions, bugs, or suggestions.
